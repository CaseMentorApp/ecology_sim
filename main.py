...
for_refrence = pd.read_csv(r"C:\Users\User\Desktop\vs_code_projects\ecology_project\for_refrence.csv")
...
folder_dir = r"C:\Users\User\Desktop\vs_code_projects\ecology_project\split"
...
for file in image_list:
    with open(r"C:\Users\User\Desktop\vs_code_projects\ecology_project\split\\" + file, "rb") as image:
...
# get the path/directory
folder_dir = r"C:\Users\User\Desktop\vs_code_projects\ecology_project\simulation_1_plants"
for images in os.listdir(folder_dir):
...
with planet:
        for image in sim1_plants:
            with st.expander(str(image)[:-4]):
                ...
                with col1:
                    with Image.open(r"C:\Users\User\Desktop\vs_code_projects\ecology_project\simulation_1_plants\\" + image) as img:
                        st.image(img)
                with col2:
